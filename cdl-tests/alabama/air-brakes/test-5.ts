...
export const alabamaAirBrakes5: Question[] = [
  {
    id: 'ab-5-1',
    question: 'What is the main purpose of a dual air brake system?',
    answers: [
      'To provide redundancy for safety',
      'To increase braking power',
      'To reduce maintenance needs',
      'To simplify brake controls'
    ],
    correctAnswers: ['To provide redundancy for safety'],
    explanation: 'A dual air brake system has two separate systems that provide backup in case one fails, enhancing safety.',
  ...
  },
  {
    ...
    answers: [
      ...
      'By pulling hard on each slack adjuster you can reach',
      'By checking their lubrication levels',
      'By testing the brakes while driving'
    ],
    correctAnswers: ['By pulling hard on each slack adjuster you can reach'],
